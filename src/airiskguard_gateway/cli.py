...
def setup() -> None:
    ...
    console.print(f"  [yellow]export ANTHROPIC_API_KEY=gateway-managed[/]    [dim]# SDK requires a value; gateway uses its own key[/]")
    console.print()
    console.print(f"  [yellow]export OPENAI_BASE_URL=http://{cfg.listen_host}:{cfg.listen_port}/openai[/]")
    console.print(f"  [yellow]export OPENAI_API_KEY=gateway-managed[/]")
    console.print()
    ...
    console.print(f"  [yellow]export ANTHROPIC_BASE_URL=http://{cfg.listen_host}:{cfg.listen_port}/anthropic[/]")
    console.print(f"  [yellow]export ANTHROPIC_API_KEY=gateway-managed[/]  [dim]# real key stays in gateway config[/]")
    console.print()
